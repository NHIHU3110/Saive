...
public class CheckoutActivity extends BaseActivity {
    ...
    private void processOrder() {
        ...
        else if (binding.rbVietQR.isChecked()) paymentMethod = "VietQR";
        ...
        double discountAmountNumeric = subTotalNumeric * discountRate;
        double finalTotalNumericValue = subTotalNumeric - discountAmountNumeric;
        String customerEmail = binding.etEmail.getText().toString().trim();
        if (customerEmail.isEmpty() && selectedAddress != null) customerEmail = "customer@saive.vn"; // fallback
        ...
        com.google.firebase.database.DatabaseReference firebaseRef = com.google.firebase.database.FirebaseDatabase.getInstance("https://saive-403f7-default-rtdb.asia-southeast1.firebasedatabase.app")
                .getReference("Orders");
        String firebaseOrderId = orderId.replace("#", ""); // Use as key
        
        Map<String, Object> firebaseOrder = new HashMap<>();
        firebaseOrder.put("OrderId", orderId);
        ...
        firebaseRef.child(firebaseOrderId).setValue(firebaseOrder);
                ...
                productsRef.child(productId).runTransaction(new com.google.firebase.database.Transaction.Handler() {
                    ...
                    public com.google.firebase.database.Transaction.Result doTransaction(@androidx.annotation.NonNull com.google.firebase.database.MutableData currentData) {
                        ...
                        if (size != null && color != null) {
                            com.google.firebase.database.MutableData sizeNode = currentData.child("Stock").child(size);
