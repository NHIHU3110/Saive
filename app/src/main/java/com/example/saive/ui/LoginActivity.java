...
public class LoginActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageUtils.setSafeImage(binding.ivFbIcon, R.drawable.fbicon);
        ImageUtils.setSafeImage(binding.ivGgIcon, R.drawable.ggicon);
        binding.ivGgIcon.setOnClickListener(v -> signInWithGoogle());
                    ...
                    public void onDataChange(
                        ...
                        for (com.google.firebase.database.DataSnapshot child : snapshot.getChildren()) {
                            ...
                            if (email.equalsIgnoreCase(dbEmail)) {
                                ...
                                if (name == null) name = child.child("DisplayName").getValue(String.class);
                                String role = child.child("role").getValue(String.class);
                                if (role == null) role = child.child("Role").getValue(String.class);
                                String avatar = child.child("avatarUrl").getValue(String.class);
                                if (avatar == null) avatar = child.child("AvatarUrl").getValue(String.class);
                                String phone = child.child("phone").getValue(String.class);
                                if (phone == null) phone = child.child("Phone").getValue(String.class);
                ...
                .addListenerForSingleValueEvent(new com.google.firebase.database.ValueEventListener() {
                    ...
                    public void onDataChange(
                        ...
                        for (com.google.firebase.database.DataSnapshot child : snapshot.getChildren()) {
                            ...
                            if (dbEmail == null)
                                dbEmail = child.child("Email").getValue(String.class);
                            String dbPwd = child.child("password").getValue(String.class);
                            if (dbPwd == null)
                                dbPwd = child.child("Password").getValue(String.class);
    ...
    private void syncGoogleUserToDatabase(com.google.firebase.auth.FirebaseUser user) {
        ...
        usersRef.addListenerForSingleValueEvent(new com.google.firebase.database.ValueEventListener() {
            ...
            public void onDataChange(@androidx.annotation.NonNull com.google.firebase.database.DataSnapshot snapshot) {
                ...
                for (com.google.firebase.database.DataSnapshot child : snapshot.getChildren()) {
                    String dbEmail = child.child("email").getValue(String.class);
                    if (dbEmail == null) dbEmail = child.child("Email").getValue(String.class);
