...
public class AboutActivity extends BaseActivity {
    ...
    private void initViews() {
        com.example.saive.utils.ImageUtils.setSafeImage(binding.ivAboutHero, R.mipmap.abouthero);
        com.example.saive.utils.ImageUtils.setSafeImage(binding.ivLinen, R.mipmap.banner1);
        com.example.saive.utils.ImageUtils.setSafeImage(binding.ivTencel, R.mipmap.atumncollection2);
        com.example.saive.utils.ImageUtils.setSafeImage(binding.ivBamboo, R.mipmap.banner2);
