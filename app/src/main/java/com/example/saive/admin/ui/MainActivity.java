...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (headerView != null) {
            ...
            // Tap logo 5 lần → Chuyển sang Customer Mode (MainActivity của app)
            View ivLogo = headerView.findViewById(R.id.ivLogo);
            if (ivLogo != null) {
                ivLogo.setOnClickListener(v -> {
                    logoClickCount++;
                    if (logoClickCount >= 5) {
                        logoClickCount = 0;
                        android.widget.Toast.makeText(this, "Switching to Customer Mode...", android.widget.Toast.LENGTH_SHORT).show();
                        Intent intent = new Intent(MainActivity.this, com.example.saive.ui.MainActivity.class);
